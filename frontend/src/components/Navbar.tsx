...
import { Home, Globe, RefreshCw, BookOpen, BarChart3, CheckCircle, FolderUp, Heart, Search } from 'lucide-react';
      ...
      >
        <div className="navbar-content">
          ...
          <div className="navbar-links navbar-desktop">
            ...
            <button className="navbar-search-btn" onClick={() => setIsSearchOpen(true)} aria-label="Arama">
              <Search size={18} />
            </button>
          </div>
        ...
        <AnimatePresence>
          {isMenuOpen && (
            ...
            >
              ...
              <button className="navbar-mobile-link" role="menuitem" onClick={() => { closeMenu(); setIsSearchOpen(true); }} style={{ width: '100%', border: 'none', background: 'none', cursor: 'pointer', textAlign: 'left', font: 'inherit', color: 'inherit' }}>
                <Search size={18} aria-hidden="true" style={{ marginRight: '0.5rem' }} /> Ara
              </button>
